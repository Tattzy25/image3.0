...
interface DalleGeneratorPanelProps {
  setIsGeneratingImage: (isGenerating: boolean) => void
}

export default function DalleGeneratorPanel({ setIsGeneratingImage }: DalleGeneratorPanelProps) {
  ...
  const handleGenerate = () => {
    ...
    // For demo purposes, we'll use a placeholder image immediately
    // No fake API calls or timeouts that could get stuck
    setTimeout(() => {
      const mockGeneratedImage = "/colorful-abstract-portrait.png"
    ...
    }, 500) // Short timeout just for visual feedback
  }
